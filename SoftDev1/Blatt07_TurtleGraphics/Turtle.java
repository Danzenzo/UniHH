...
class Turtle
{
    ...
    public void zeichneNEck(int Ecken, String farbe, int x, int y)
    {
        setzeFarbe(farbe);
        _x = x;
        _y = y;
        ...
        {
            drehe(180 - (((Ecken - 2) * 180)/Ecken));
            geheVor(50);
        }
    }

    public void zeichneNEck(int Ecken, String farbe, int x, int y, int anzahl, int laenge)
    {
        setzeFarbe(farbe);
        _x = x;
        _y = y;
        for(int n=0,a = laenge ;n<anzahl && a > 0 ;n++, a -=5)
        {
            for(int i=0;i<Ecken;i++)
            {
                drehe(180 - (((Ecken - 2) * 180)/Ecken));
