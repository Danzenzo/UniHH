...
class Girokonto
{
  ...
  private List<Kontobewegung> _kontobewegung ;
    ...
    public Girokonto()
    {
       _kontobewegung = new ArrayList<Kontobewegung>();
        _saldo = 0;
        _dispoLimit = 0;
    }
    ...
    public void zahleEin(int betrag)
    {
        ...
        _kontobewegung.add(new Kontobewegung(betrag));
    }
    ...
    {
       for (Kontobewegung k : _kontobewegung)
      {
